...
def test_context_processors(client, base_app):
    @base_app.security.context_processor
    def default_ctx_processor():
        return {"global": "global"}

    @base_app.security.forgot_password_context_processor
    def forgot_password():
        return {"foo": "bar"}
    ...
    @base_app.security.login_context_processor
    def login():
        return {"foo": "bar"}
    ...
    @base_app.security.register_context_processor
    def register():
        return {"foo": "bar"}
    ...
    @base_app.security.reset_password_context_processor
    def reset_password():
        return {"foo": "bar"}
    ...
    @base_app.security.change_password_context_processor
    def change_password():
        return {"foo": "bar"}
    ...
    @base_app.security.send_confirmation_context_processor
    ...
    @base_app.security.mail_context_processor
    def mail():
        return {"foo": "bar"}
