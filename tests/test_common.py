...
def test_authenticate_case_insensitive_email(base_app, client):
...
def test_user_deleted_during_session_reverts_to_anonymous_user(base_app, client):
    authenticate(client)

    with base_app.test_request_context("/"):
        user = base_app.security.datastore.find_user(email="matt@lp.com")
        base_app.security.datastore.delete_user(user)
